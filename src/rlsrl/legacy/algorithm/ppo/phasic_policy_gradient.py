...
from rlsrl.api.trainer import SampleBatch, TrainerStepResult, register
from rlsrl.legacy.algorithm.ppo.mappo import MultiAgentPPO
from rlsrl.base.namedarray import recursive_aggregate, recursive_apply, NamedArray
...
class MultiAgentPPG(MultiAgentPPO):
    ...
    def __init__(self, policy: rlsrl.api.policy.Policy, **kwargs):
